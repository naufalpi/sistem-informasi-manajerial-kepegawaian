...
<body>
    ...
    <div class="content" style="text-align: justify;">
        ...
        <p>Karena Saudara/i {{ $kepensiunan->perangkat_desa }} menjadi {{ $kepensiunan->jabatan }} sebagaimana Keputusan Kepala Desa Wanakarsa Nomor {{ $kepensiunan->nomor_kkd }} tertanggal {{ $kepensiunan->tanggal_kkd_formatted }} telah habis masa jabatannya, maka dengan ini mohon kepada Saudara Camat Wanadadi untuk memberikan rekomendasi untuk pemberhentiannya dari Perangkat Desa dalam jabatan {{ $kepensiunan->jabatan }}.</p><br>

            ...
            <div class="card">
                <div class="card-body">
                  ...
                  <form method="post" action="/dashboard/kepensiunan" class="mb-5">
                    ...
                    <div class="row mb-3">
                        <label for="nomor_kkd" class="col-sm-2 col-form-label">Nomor Keputusan Kepala Desa</label>
                        <div class="col-sm-10">
                            <input type="string" class="form-control  @error('nomor_kkd') is-invalid @enderror" id="nomor_kkd" name="nomor_kkd" required autofocus value="{{ old('nomor_kkd') }}">
                            @error('nomor_kkd')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
                    ...
                    <div class="row mb-3">
                        <label for="tanggal_kkd" class="col-sm-2 col-form-label">Tanggal Keputusan Kepala Desa</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control  @error('tanggal_kkd') is-invalid @enderror" id="tanggal_kkd" name="tanggal_kkd" required autofocus value="{{ old('tanggal_kkd') }}">
                            @error('tanggal_kkd')
                                <div class="invalid-feedback">
                                {{ $message }}
                                </div>
